...
object GraphicsRuntime {
    fun prepare(context: Context, session: File, log: (String) -> Unit): List<File> {
        ...
        val names = setOf("libwurm_lwjgl3.so", "libwurm_lwjgl3_opengl.so", "libgl4es.so", "libwurm_graphics.so", "libwurm_openal.so", ClientNativeHeap.runtime, ClientNativeHeap.cxx)
