...
public final class ServerPreflight {
    public static void main(String[] args) throws Exception {
        if (args.length != 3) throw new IllegalArgumentException("Expected disposable session, imported runtime and selected world");
        ServerDatabasePreflight.verify(Path.of(args[1]),args[2]);
