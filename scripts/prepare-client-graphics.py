...
def main():
    ...
    gl4es_patch.apply_mipmap_realization(gl4es, ROOT/'graphics-compat/native')
    ...
    manifest = dict(id='wurm-graphics-2', backend='LWJGL/Pojav Java GLFW + GL4ES, owned EGL window/readback diagnostic',
                    ndk='26.1.10909125', abi='arm64-v8a', sources=pins, gl4esPatches=['custom-fragment-global-scope', 'bounded-native-draw-breadcrumb', 'internal-client-pointer-addresses', 'vao-buffer-offset-addresses', 'program-cache-cleanup', 'supported-depth24', 'error-origin-breadcrumbs', 'mipmap-base-image-and-unit', 'synchronous-mipmap-error-context'],
