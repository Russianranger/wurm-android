...
with zipfile.ZipFile(sys.argv[1]) as apk:
    ...
    with zipfile.ZipFile(io.BytesIO(apk.read("assets/wurm-window.jar"))) as window:
        ...
        for name in ("org/lwjgl/glfw/GLFW.class", "wurm/graphics/WindowBackend.class", "wurm/graphics/WindowProbe.class", "wurm/graphics/OffscreenSupport.class", "wurm/graphics/ShaderQueries.class"):
